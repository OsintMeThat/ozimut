...
- **Delete/edit sync is two-way**: an artifact and its sidebar entity are one
  ...
  underlying file(s). One satellite capture ⇄ one `place` entity (tied by file
